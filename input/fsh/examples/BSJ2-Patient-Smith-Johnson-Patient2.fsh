Instance: Example-Smith-Johnson-Patient2
InstanceOf: $USCorePatient
Usage: #example
Title: "Example: Patient2 - Betsy Smith-Johnson"
Description: "Basic information for fictional patient Betsy Smith-Johnson second scenario."
