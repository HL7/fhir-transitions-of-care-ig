Instance: JF-ProblemList-PressureInjury
InstanceOf: $USCoreConditionProblemsandHealthConcerns // $PFEConditionProblemsandHealthConcerns
Usage: #example
Title: "Example: JF Pressure Injury"
Description: "Stage II wound from Left hip pressure injury on patient Jane Fiction."
