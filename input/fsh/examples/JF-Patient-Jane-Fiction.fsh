Instance: Example-Fiction
InstanceOf: $USCorePatient
Usage: #example
Title: "Example: Patient2 - Jane Fiction"
Description: "Basic information for fictional patient Jane Fiction second scenario."

* meta.lastUpdated = "2021-03-29T14:25:34.001-05:00"
* meta.profile = Canonical(us-core-patient|8.0.1)
* language = #en-US
...
* identifier[=].value = "1032702A"
* identifier[+].system = "http://hl7.org/fhir/sid/us-medicare"
* identifier[=].value = "1AA3D58WH26"
* active = true
* name.use = #usual
* name.text = "Jane Fiction"
* name.family = "Fiction"
* name.given = "Jane"
* gender = #female
...
* contact[=].name.text = "Charles Fiction"
...
* contact[=].name.text = "Debra Fiction"
* contact[=].telecom.system = #phone
